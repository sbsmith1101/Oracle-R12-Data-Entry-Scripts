...
For N = 1 To 20
    ...
    If Left(txt1, 1) = "N" Then Application.SendKeys "%err"
    If Left(txt1, 1) = "R" Then Application.SendKeys "%err"
    If Left(txt1, 1) = "B" Then Application.SendKeys "%err"
    If Left(txt1, 1) = "X" Then Application.SendKeys "%err"
